...
public class AndroidChessActivity extends Activity {
	...
	private void startTimer1() {
		mCountDownTimer1 = new CountDownTimer(mTimeLeftInMillis1, 1000) {
			...
			public void onFinish() {
				mTimerRunning1 = false;
				print("Белые выиграли, У черных закончилось время");
				write("", data);
	...
	private void startTimer() {
		mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
			...
			public void onFinish() {
				mTimerRunning = false;
				print("Черные выиграли, У белых закончилось время");
				write("", data);
				print("Данные сохранены!");
				print("Спасибо за игру!");
			}
    ...
    public void game_status(int game) {
    	...
    	boolean over = false;
    	if (game == 1) {
    		text = "-- Шах и Мат: Белые выиграли! --";
    		over = true;
    	} else if (game == 2) {
    		text = "-- Шах и Мат: Черные выиграли! --";
    		over = true;
    	} else if (game == 3) {
    		text = "-- Уступил: Черные выиграли! --";
    		over = true;
    	} else if (game == 4) {
    		text = "-- Уступил: Белые выиграли! --";
    		over = true;
    	} else if (game == 5) {
    		text = "-- Ничья! --";
    		over = true;
    	} else if (game == 6) {
    		text = "-- Фигура не существует! --";
    	} else if (game == 7) {
    		text = "-- Это не ваша фигура --";
    	} else if (game == 8) {
